...
function home()
{
    ...
    // mostrar lista
    const contenerdorpokes = document.createElement("div")
    contenerdorpokes.id= "la-lista"

    contenerdorpokes.innerHTML= generarLista(pokemones)
    
    document.getElementById("root").appendChild(buscador)
    document.getElementById("root").appendChild(contenedorFiltro)
    document.getElementById("root").appendChild(contenerdorpokes)
